...
<head>
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="public/dasboard/img/favicon.ico">
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            <li class=""><a href="user"> <i><img src="public/dasboard/icon/home.png"></i>Home </a></li>
            <!-- <li class=""><a href="asli"> <i><img src="public/dasboard/icon/accspv.png"></i>ACC Pengajuan </a></li> -->
            <!-- <li class=""><a href="#"> <i><img src="public/dasboard/icon/accspv.png"></i>Approval Pengajuan </a></li> -->
            <li class="active"><a  href="#tablesDropdown" aria-expanded="false" data-toggle="collapse"> <i><img src="public/dasboard/icon/history.png"></i>History Data</a>
              <ul id="tablesDropdown" class="collapse list-unstyled ">
                <li><a href="useracc">Data Di acc (Diterima)</a></li>
                <li><a href="usertolak">Data Ditolak</a></li>
                <li class="active"><a href="userall">Semua Data Masuk</a></li>
              </ul>
            </li>
            <li><a href="#chartsDropdown" aria-expanded="false" data-toggle="collapse"> <i><img src="public/dasboard/icon/rangking.png"></i>Rangking</a>
              <ul id="chartsDropdown" class="collapse list-unstyled ">
                <li><a href="userrank">Pengurutan Nilai</a></li>
            ...
            <li><a href="#formsDropdown" aria-expanded="false" data-toggle="collapse"> <i><img src="public/dasboard/icon/form.png"></i>Pengajuan</a>
              <ul id="formsDropdown" class="collapse list-unstyled ">
                <li><a href="insert">Form Pengajuan</a></li>
