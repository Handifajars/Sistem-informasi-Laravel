          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a href="spvinfrastruktur" class="navbar-brand d-none d-sm-inline-block">
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            <li class=""><a href="spvinfrastruktur"> <i><img src="public/dasboard/icon/home.png"></i>Home </a></li>
            <li class=""><a href="spvnilaiinfrastruktur"> <i><img src="public/dasboard/icon/accspv.png"></i>ACC Pengajuan </a></li>
            ...
            <li><a href="#tablesDropdown" aria-expanded="false" data-toggle="collapse"> <i><img src="public/dasboard/icon/history.png"></i>History Data</a>
              <ul id="tablesDropdown" class="collapse list-unstyled ">
                <li><a href="spvaccinfrastruktur">Data Di acc (Diterima)</a></li>
                <li><a href="spvtolakinfrastruktur">Data Ditolak</a></li>
                <li><a href="spvallinfrastruktur">Semua Data Masuk</a></li>
              </ul>
            </li>
            <li><a href="#chartsDropdown" aria-expanded="false" data-toggle="collapse"> <i><img src="public/dasboard/icon/rangking.png"></i>Ranking</a>
              <ul id="chartsDropdown" class="collapse list-unstyled ">
                <li><a href="spvrankinfrastruktur">Pengurutan Nilai</a></li>
                ...
                <!-- <div class="card-body"> -->
                  ...
                  <div class="table-responsive">
                    <table border="1" id="" style="width: 100%;" class="table">
                      <thead>
                        <tr class="head">
                        <th>Nama Kebutuhan</th><th>Asal Devisi</th><th>Ket Lanjutan</th><th>Fungsi Kebutuhan</th><th>Waktu</th><th>spv</th><th>point</th><th></th></tr>
                        </thead>
                        @foreach($data as $masuk)
                        <form action="{{ url('hasilinfrastruktur').'/'.$masuk->waktu}}" method="POST">
                          {{ csrf_field() }}
                          <tr>
                            ...
                            <td>{{$masuk->spv}}</td>
                            <td>{{$masuk->point}}</td>
                            <th><button type="submit">nilai!</button></th>
                          </tr>
                        </form>
                      @endforeach
                    </tbody>
